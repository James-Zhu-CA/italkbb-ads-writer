...
- 若用户未特别指定文案语体风格，默认按目标人群采用对应广告语体：
  - 香港地区人群 -> 港式繁体广告用语与语气
  - 台湾地区人群 -> 台式繁体广告用语与语气
  - 大陆地区人群 -> 大陆简体广告用语与语气
  - 北美英文人群 -> North America English 广告用语与语气
- 若语体归属不明确，必须根据 Step 3 的语言文化背景与使用场景做推断，并在 `Language Localization Profile` 里记录选择理由。
...
- 若用户未特别指定语体，Step 6 必须按 Step 3 默认语体规则执行（港式繁体/台式繁体/大陆简体/北美英文），不得使用中性混合语体替代。  
- 多人群任务必须分人群独立输出，不得混写。  
